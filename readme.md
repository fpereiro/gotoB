...
The current version of gotoв, v0.4.0, is considered to be *unstable* and *somewhat complete*. [Suggestions](https://github.com/fpereiro/gotoB/issues) and [patches](https://github.com/fpereiro/gotoB/pulls) are welcome. Besides bug fixes, these are the future changes planned:

- Add documentation.
- Improvements to the API.
- Performance improvements & `trample` mode.
...
```html
<script src="https://cdn.rawgit.com/fpereiro/gotoB/65cb6ee8dd1804ed5308afb5264446b5c7b4d6da/gotoB.min.js"></script>
```
...
- **Trivial to set up**: add `<script src="https://cdn.rawgit.com/fpereiro/gotoB/65cb6ee8dd1804ed5308afb5264446b5c7b4d6da/gotoB.min.js"></script>` at the bottom of the `<body>`.
