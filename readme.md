...
```html
<script src="https://cdn.jsdelivr.net/gh/fpereiro/gotob@feeec8adc2fe92f3429fb93fa0f029f37c554700/gotoB.min.js"></script>
```
...
- **Trivial to set up**: add `<script src="https://cdn.jsdelivr.net/gh/fpereiro/gotob@feeec8adc2fe92f3429fb93fa0f029f37c554700/gotoB.min.js"></script>` at the bottom of the `<body>`.
