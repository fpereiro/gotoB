...
The current version of gotoв, v1.2.5, is considered to be *somewhat stable* and *mostly complete*. [Suggestions](https://github.com/fpereiro/gotoB/issues) and [patches](https://github.com/fpereiro/gotoB/pulls) are welcome. Besides bug fixes, these are the future changes planned:
...
```html
<script src="https://cdn.jsdelivr.net/gh/fpereiro/gotob@b0b0d6824019233777a016fd98b2b7601d018a08/gotoB.min.js"></script>
```
...
- **Trivial to set up**: add `<script src="https://cdn.jsdelivr.net/gh/fpereiro/gotob@b0b0d6824019233777a016fd98b2b7601d018a08/gotoB.min.js"></script>` at the top of the `<body>`.
...
The complete source code is contained in `gotoB.js`. gotoв itself is about 720 lines long; its dependencies are about 1290 lines; the whole thing is about 1990 lines.
